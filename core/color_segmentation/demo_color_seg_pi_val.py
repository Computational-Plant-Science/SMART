...
python3 color_seg_pi_val.py -p ~/example/plant_test/ -ft jpg -c 0 -min 100  -max 1500

python3 color_seg_pi_val.py -p ~/example/plant_test/ -ft jpg -nr 4 -nc 6 -tp ~/example/pi_images/marker_template/16-1_6-23_sticker_match.jpg
